...
ALTER TABLE [dbo].[Application] WITH NOCHECK ADD 
    CONSTRAINT [PK_Application] PRIMARY KEY NONCLUSTERED ([ErrorId]) ON [PRIMARY] 
GO
...
INSERT INTO [Application](ErrorId, Name)
SELECT NEWID(), 'Rex Admin' UNION ALL
SELECT NEWID(), 'Gift Cards' UNION ALL
SELECT NEWID(), 'Eos' UNION ALL
SELECT NEWID(), 'Agency Invoicing' UNION ALL
SELECT NEWID(), 'Ticketfeeds' UNION ALL
SELECT NEWID(), 'Press'
